...
def Test_ebgp_route_prefix():
    test_const = {
        ...
        "txRouteCount": 5,
        "rxRouteCount": 5,
        "txNextHopV4": "22.1.1.1",
        "txNextHopV6": "::1:1:1:3",
        "rxNextHopV4": "23.1.1.1",
        "rxNextHopV6": "::1:1:1:4",
    ...
    api = snappi.api(location="https://172.16.14.106:8443", verify=False)
...
def ebgp_route_prefix_config(api, tc):
    ...
    ptx = c.ports.add(name="ptx", location="172.16.14.106:5555;1+172.16.14.106:50071;ens4")
    prx = c.ports.add(name="prx", location="172.16.14.106:5555;2+172.16.14.106:50071;ens5")
    ...
    dtx_bgpv4_peer.set(
        ...
        as_number=tc["txAs"], as_type=dtx_bgpv4_peer.EBGP, peer_address="1.1.1.1"
    )
    ...
    drx_bgpv4_peer.set(
        ...
        as_number=tc["rxAs"], as_type=drx_bgpv4_peer.EBGP, peer_address="1.1.1.1"
    )
