...
def Test_otg_flows():
    ...
    if API == None:
        API = "https://10.36.87.210:8443"

    P1_LOCATION=os.environ.get('OTG_LOCATION_P1')
    if P1_LOCATION == None:
        P1_LOCATION = "10.36.87.210:5555;1+10.36.87.210:50071;ens4"

    P2_LOCATION=os.environ.get('OTG_LOCATION_P2')
    if P2_LOCATION == None:
        P2_LOCATION = "10.36.87.210:5555;2+10.36.87.210:50071;ens5"
    ...
    ip1.src.value, ip1.dst.value = "20.0.0.1", "20.0.0.2"
    ip2.src.value, ip2.dst.value = "30.0.0.2", "30.0.0.1"
